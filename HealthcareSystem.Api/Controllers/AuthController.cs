...
using HealthcareSystem.Business.Dto.Requests;
using HealthcareSystem.Business.Dto.Responses;
    ...
    public class AuthController : ControllerBase
    {
        ...
        private async Task<AuthResult> VerifyAndGenerateToken(TokenRequest tokenRequest)
        {
            ...
            try
            {
                ...
                var storedToken = await _authDbContext.RefreshTokens.FirstOrDefaultAsync(x => x.Token == tokenRequest.RefreshToken);
