...
namespace HealthcareSystem.Business.Service
{
    ...
    {
        private readonly IRepository<Appointment, BaseDbContext> _repository;
        private readonly IMapper _mapper;

        public AppointmentService(IRepository<Appointment, BaseDbContext> repository, IMapper mapper) : base(repository, mapper)
        {
